...
mrpt_msgs__msg__ObservationRangeBearing__create(void)
{
...
mrpt_msgs__msg__ObservationRangeBearing__Sequence__init(mrpt_msgs__msg__ObservationRangeBearing__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(mrpt_msgs__msg__ObservationRangeBearing)) {
      return false;
    }
  ...
  mrpt_msgs__msg__ObservationRangeBearing__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(mrpt_msgs__msg__ObservationRangeBearing)) {
      return false;
    }
