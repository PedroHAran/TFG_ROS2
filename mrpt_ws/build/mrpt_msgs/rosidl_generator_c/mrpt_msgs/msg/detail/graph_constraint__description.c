...
mrpt_msgs__msg__GraphConstraint__get_type_hash(
...
static char mrpt_msgs__msg__GraphConstraint__FIELD_NAME__node_id_from[] = "node_id_from";
static char mrpt_msgs__msg__GraphConstraint__FIELD_NAME__node_id_to[] = "node_id_to";
static char mrpt_msgs__msg__GraphConstraint__FIELD_NAME__constraint[] = "constraint";

static rosidl_runtime_c__type_description__Field mrpt_msgs__msg__GraphConstraint__FIELDS[] = {
  {
    {mrpt_msgs__msg__GraphConstraint__FIELD_NAME__node_id_from, 12, 12},
    {
  ...
  {
    {mrpt_msgs__msg__GraphConstraint__FIELD_NAME__node_id_to, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT64,
      0,
      0,
  ...
  {
    {mrpt_msgs__msg__GraphConstraint__FIELD_NAME__constraint, 10, 10},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mrpt_msgs__msg__GraphConstraint__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
mrpt_msgs__msg__GraphConstraint__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mrpt_msgs__msg__GraphConstraint__FIELDS, 3, 3},
    },
    {mrpt_msgs__msg__GraphConstraint__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
mrpt_msgs__msg__GraphConstraint__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
mrpt_msgs__msg__GraphConstraint__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mrpt_msgs__msg__GraphConstraint__get_individual_type_description_source(NULL),
