...
static char mrpt_msgs__msg__NodeIDWithPoseVec__FIELD_NAME__vec[] = "vec";

static rosidl_runtime_c__type_description__Field mrpt_msgs__msg__NodeIDWithPoseVec__FIELDS[] = {
  {
    {mrpt_msgs__msg__NodeIDWithPoseVec__FIELD_NAME__vec, 3, 3},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mrpt_msgs__msg__NodeIDWithPoseVec__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mrpt_msgs__msg__NodeIDWithPoseVec__FIELDS, 1, 1},
    },
    {mrpt_msgs__msg__NodeIDWithPoseVec__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[3].fields = mrpt_msgs__msg__NodeIDWithPose__get_type_description(NULL)->type_description.fields;
...
mrpt_msgs__msg__NodeIDWithPoseVec__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mrpt_msgs__msg__NodeIDWithPoseVec__get_individual_type_description_source(NULL),
    sources[1] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[2] = *geometry_msgs__msg__Pose__get_individual_type_description_source(NULL);
    sources[3] = *geometry_msgs__msg__Quaternion__get_individual_type_description_source(NULL);
    sources[4] = *mrpt_msgs__msg__NodeIDWithPose__get_individual_type_description_source(NULL);
