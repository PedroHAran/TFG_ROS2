...
static char mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__name[] = "name";
static char mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__hostname[] = "hostname";
static char mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__ip_addr[] = "ip_addr";
static char mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__port[] = "port";
static char mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__is_online[] = "is_online";
static char mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__last_seen_time[] = "last_seen_time";
static char mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__topic_namespace[] = "topic_namespace";
static char mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__agent_id[] = "agent_id";

static rosidl_runtime_c__type_description__Field mrpt_msgs__msg__GraphSlamAgent__FIELDS[] = {
  {
    {mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__hostname, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__ip_addr, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__port, 4, 4},
    {
  ...
  {
    {mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__is_online, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__last_seen_time, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__topic_namespace, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mrpt_msgs__msg__GraphSlamAgent__FIELD_NAME__agent_id, 8, 8},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mrpt_msgs__msg__GraphSlamAgent__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mrpt_msgs__msg__GraphSlamAgent__FIELDS, 8, 8},
    },
    {mrpt_msgs__msg__GraphSlamAgent__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = std_msgs__msg__Bool__get_type_description(NULL)->type_description.fields;
...
mrpt_msgs__msg__GraphSlamAgent__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {mrpt_msgs__msg__GraphSlamAgent__TYPE_NAME, 28, 28},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 951, 951},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mrpt_msgs__msg__GraphSlamAgent__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *std_msgs__msg__Bool__get_individual_type_description_source(NULL);
